            ...
            if ($mailer->isConfigured()) {
                ...
                <head>
                    ...
                    <style>
                        ...
                        .info-box { background: #f8fbf8; border-left: 4px solid #2D5A27; padding: 20px; margin: 20px 0; border-radius: 8px; }
                        .field { margin-bottom: 15px; }
                        .label { font-weight: 600; color: #2D5A27; margin-bottom: 5px; }
                        .value { background: #f5f5f5; padding: 12px; border-radius: 8px; margin-top: 5px; border: 1px solid #e0e0e0; }
                        .footer { text-align: center; padding: 25px; background: #f0f0f0; color: #666; font-size: 13px; border-top: 1px solid #ddd; }
                    </style>
                </head>
                <body>
                    <div class='container'>
                        ...
                        <div class='content'>
                            ...
                            <div class='info-box'>
                                ...
                                <div class='field'><div class='label'>📧 Email:</div><div class='value'><a href='mailto:" . htmlspecialchars($email) . "'>" . htmlspecialchars($email) . "</a></div></div>
                                ...
                                <div class='field'><div class='label'>⏰ Received:</div><div class='value'>" . date('F j, Y, g:i a') . "</div></div>
                            </div>
                            <p><a href='mailto:" . htmlspecialchars($email) . "' style='display: inline-block; padding: 12px 25px; background: #2D5A27; color: white; text-decoration: none; border-radius: 30px;'>Reply to " . htmlspecialchars($name) . "</a></p>
